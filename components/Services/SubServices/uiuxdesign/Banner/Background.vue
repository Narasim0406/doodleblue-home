 ...
 */
  ...
  background: rgb(11, 53, 115); /* Old browsers */
  ...
  filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#11e8bb', endColorstr='rgb(36, 10, 68)',GradientType=0 ); /* IE6-9 */

  /* background: linear-gradient(45deg, rgb(36, 10, 68) 0%, rgb(11, 53, 115) 100%); */
