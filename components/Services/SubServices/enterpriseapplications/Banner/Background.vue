<template>
  <div style="width: 100%; height: 100%; overflow: hidden;" id="canva">
...
export default {
  ...
  mounted() {
    ...
    */
    ...
    // background: linear-gradient(45deg, rgb(53, 198, 204) 0%, rgb(59, 71, 217) 100%);
    ...
    var draw = function() {
      ...
      g_.addColorStop(0, 'hsla(182, 60%, 50%, 1)')
      g_.addColorStop(1, 'hsla(235, 68%, 54%, 1)')
