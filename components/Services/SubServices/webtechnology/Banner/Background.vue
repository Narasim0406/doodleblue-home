...
export default {
  ...
  mounted() {
    if (process.client) {
      ...
      function loop() {
        // ctx.fillStyle = `rgba(0, 100, 100, ${opacity})`;
        // ctx.fillStyle = `rgba(222, 163, 71, ${opacity})`;
        ctx.fillStyle = 'rgba(222, 163, 71, 1)'
        // ctx.fillStyle = 'linear-gradient(45deg, rgb(224, 182, 76) 0%, rgb(218, 112, 55) 100%)';
      ...
      /*
    https://codepen.io/funxer/pen/Zvjebx?editors=0010
 */
    }
  }
}
